    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="relative w-full h-[600px] overflow-hidden">
        ...
        <Button
          ...
          className="absolute top-1/2 left-4 -translate-y-1/2 bg-white/80 hover:bg-white rounded-full shadow"
        >
          <ChevronLeftIcon className="w-4 h-4" />
        </Button>
        ...
        <Button
          ...
          className="absolute top-1/2 right-4 -translate-y-1/2 bg-white/80 hover:bg-white rounded-full shadow"
        >
          <ChevronRightIcon className="w-4 h-4" />
        </Button>
